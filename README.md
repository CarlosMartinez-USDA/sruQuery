...
For more SRU Query examples check out [SRU is Simple](https://github.com/CarlosMtz3/sruQuery/wiki/SRU-is-Simple) on the [wiki](ttps://github.com/CarlosMtz3/sruQuery/wiki/)
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYwMTEzMTE2NCwtMTcxMTcxMDQ4MV19
-->